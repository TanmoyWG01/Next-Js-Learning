 ...
 * ⚠️ Server-only mock replacement for Prisma
 */
...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 129.0,
    description:
      "Water-resistant 28L pack with padded laptop sleeve and quick access pockets.",
  ...
  },
  {
    ...
    price: 22.5,
    description:
      "Hand-glazed stoneware mug with a heat-retaining double wall.",
